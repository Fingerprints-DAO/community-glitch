...
const mintEditionHTMLPath =
  'https://ipfs.io/ipfs/QmdyXgx5XdFn9BzrRpr5nSK64FhRYBVYWYVjEXbgz5eFD4/'
const mintEditionThumbnailPath =
  'https://ipfs.io/ipfs/QmViy4kyGpFATnL3pS26b1do4MU3ygJ54XM9hX59dgNws7/'
...
function generateMetadata(nftIndex: number) {
  const htmlUrl = `${mintEditionHTMLPath}${nftIndex}.html`
  const versions = tokensVersions[nftIndex - 1]
  const image = `${mintEditionThumbnailPath}${nftIndex}.png`
